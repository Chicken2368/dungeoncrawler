        ...
        for y, row in enumerate(data):
            for x, tile in enumerate(row):
                ...
                if tile == 7:
                    ...
                    coin = Item(image_x, image_y, 0, item_images[0], True)
                    self.item_list.append(coin)
                    tile_data[0] = tile_list[0]
                elif tile == 10:
                    potion = Item(image_x, image_y, 1, item_images[1], True)
                    ...
                    enemy = Character(image_x, image_y, 1000, mob_animations,  6, True, 2)
                    self.character_list.append(enemy)
                    tile_data[0] = tile_list[0]
                if tile >= 0:
